...
| A-02 | 待合并 | feat/admin-ops | （本提交） | npm test 通过；UI 已接线 `admin/index.html` / `admin.js` / `risk-console.js`。需执行 migrations/202608310002_admin_risk_console.sql 后联调。IP/OTP 明细依赖安全线表 registration_ip_log / otp_send_log，表未就绪时 RPC 返回空数组。 |
