...
| 管理端 | feat/admin-ops | A-02 | 进行中（RPC 已推，UI 待推） |
...
| A-02 | 进行中 | feat/admin-ops | 808a14b | RPC migration 已推；管理端 UI（admin/index.html、admin.js、admin-ops.js）与完整 admin-ops.sql 本地已改、待推送 |
